...
The [`IO`]() Class will be responsible by storing which events you want to be subscribed to and update them through 
...
These events are created via the [`ioEvent`]() Class and pushed via [`IO.listenToEvent`](). `ioEvents` can have the
...
There are way more oddities, you can check the [typings](https://gitlab.com/moshmage/rxjs-socket.io/wikis/rxjs-socket.io.d.ts)
or the [documentation](https://moshmage.gitlab.io/rxjs-socket.io/) generated by typedoc.